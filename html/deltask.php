...
$conn = mysqli_connect('localhost','root','123456');
	...
	if($result){
		if(isset($_SESSION['userid'])){											
				...
				echo "<a href=\"javascript:void(0);\" onclick=\"show_mygoods(".$row['id'].",'mytask')\"><button class=\"button button-glow button-border button-rounded button-primary\" style=\"padding: 0px 5px;border: none;font-size: 14px;width: 100%\">确认完成</button></a>";
